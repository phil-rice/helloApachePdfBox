...
public interface IPdfPrinter {
    ...
    static PDPage getPdPage(PDDocument doc, int pageNo) {
        try {
            return doc.getDocumentCatalog().getPages().get(pageNo);
        } catch (Exception e) {
            throw new IllegalArgumentException("Cannot open page " + pageNo, e);
        }
    }
